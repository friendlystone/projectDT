...
@Component({
  selector: 'app-update-event2',
  templateUrl: './update-event2.component.html',
  styleUrls: ['./update-event2.component.css']
})

export class UpdateEventComponent2 implements OnInit {
  exform: any;
